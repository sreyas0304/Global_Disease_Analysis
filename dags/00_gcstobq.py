...
with DAG(
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='bkt-medi-global-data',  # Replace with your bucket name
        source_objects=['global_health_data.csv'],  # Path to your file in the bucket
        destination_project_dataset_table='medical-treatment-analysis.staging_dataset.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV', 
